...
namespace EveTradeAnalysis
{
	...
	private: System::Windows::Forms::GroupBox^  group_estimate;
	private: System::Windows::Forms::TextBox^  info_estimate;
	...
	private: System::Windows::Forms::CheckBox^  check_debugOutput;
	private: System::Windows::Forms::TabControl^  tab_menu;
	private: System::Windows::Forms::TabPage^  tabPage_settings;
	private: System::Windows::Forms::TabPage^  tabPage_conversion;

	private: System::Windows::Forms::Label^  label_maxJumpsPerTrip;
	private: System::Windows::Forms::NumericUpDown^  numeric_maxJumpsPerTrip;
	...
	private: System::Windows::Forms::NumericUpDown^  numeric_maxJumpsToStart;
	...
	private: System::Windows::Forms::Label^  label_maxJumpsToStart;
	...
	private: System::Windows::Forms::CheckBox^  check_maxJumpsPerTrip;


	private: System::Windows::Forms::CheckBox^  check_maxJumpsToStart;
	private: System::Windows::Forms::OpenFileDialog^  openFile;
	private: System::Windows::Forms::GroupBox^  group_analysis;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->check_debugOutput = (gcnew System::Windows::Forms::CheckBox());
			...
			this->check_maxJumpsPerTrip = (gcnew System::Windows::Forms::CheckBox());
			this->label_availableFunds = (gcnew System::Windows::Forms::Label());
			this->numeric_maxJumpsPerTrip = (gcnew System::Windows::Forms::NumericUpDown());
			this->check_maxJumpsToStart = (gcnew System::Windows::Forms::CheckBox());
			this->numeric_maxJumpsToStart = (gcnew System::Windows::Forms::NumericUpDown());
			this->text_shipVolume = (gcnew System::Windows::Forms::TextBox());
			this->label_shipVolume = (gcnew System::Windows::Forms::Label());
			this->label_maxJumpsPerTrip = (gcnew System::Windows::Forms::Label());
			this->text_availableFunds = (gcnew System::Windows::Forms::TextBox());
			this->label_maxJumpsToStart = (gcnew System::Windows::Forms::Label());
			...
			this->group_analysis = (gcnew System::Windows::Forms::GroupBox());
			...
			this->group_estimate = (gcnew System::Windows::Forms::GroupBox());
			this->info_estimate = (gcnew System::Windows::Forms::TextBox());
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->numeric_maxJumpsPerTrip))->BeginInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->numeric_maxJumpsToStart))->BeginInit();
			this->tabPage_conversion->SuspendLayout();
			this->group_convertDB->SuspendLayout();
			this->group_analysis->SuspendLayout();
			...
			this->group_estimate->SuspendLayout();
			this->SuspendLayout();
			// 
			// check_debugOutput
			// 
			this->check_debugOutput->AutoSize = true;
			this->check_debugOutput->Location = System::Drawing::Point(6, 243);
			this->check_debugOutput->Name = L"check_debugOutput";
			this->check_debugOutput->Size = System::Drawing::Size(129, 17);
			this->check_debugOutput->TabIndex = 0;
			this->check_debugOutput->Text = L"Enable Debug Output";
			this->check_debugOutput->UseVisualStyleBackColor = true;
			this->check_debugOutput->CheckedChanged += gcnew System::EventHandler(this, &EveGui::check_debugOutput_CheckedChanged);
			// 
			// tab_menu
			// 
			...
			this->group_settings->Controls->Add(this->check_maxJumpsPerTrip);
			this->group_settings->Controls->Add(this->label_availableFunds);
			this->group_settings->Controls->Add(this->numeric_maxJumpsPerTrip);
			this->group_settings->Controls->Add(this->check_maxJumpsToStart);
			this->group_settings->Controls->Add(this->numeric_maxJumpsToStart);
			this->group_settings->Controls->Add(this->text_shipVolume);
			this->group_settings->Controls->Add(this->label_shipVolume);
			this->group_settings->Controls->Add(this->check_debugOutput);
			this->group_settings->Controls->Add(this->label_maxJumpsPerTrip);
			this->group_settings->Controls->Add(this->text_availableFunds);
			this->group_settings->Controls->Add(this->label_maxJumpsToStart);
			...
			this->label1->Location = System::Drawing::Point(6, 178);
			...
			this->numeric_ignoreSellOrderVolumes->Location = System::Drawing::Point(74, 194);
			...
			this->check_ignoreSellOrderVolume->Location = System::Drawing::Point(6, 197);
			...
			this->check_ignoreJumpToStart->Location = System::Drawing::Point(6, 220);
			...
			// 
			// check_maxJumpsPerTrip
			// 
			this->check_maxJumpsPerTrip->AutoSize = true;
			this->check_maxJumpsPerTrip->Location = System::Drawing::Point(6, 155);
			this->check_maxJumpsPerTrip->Name = L"check_maxJumpsPerTrip";
			this->check_maxJumpsPerTrip->Size = System::Drawing::Size(59, 17);
			this->check_maxJumpsPerTrip->TabIndex = 10;
			this->check_maxJumpsPerTrip->Text = L"Enable";
			this->check_maxJumpsPerTrip->UseVisualStyleBackColor = true;
			this->check_maxJumpsPerTrip->CheckedChanged += gcnew System::EventHandler(this, &EveGui::check_maxJumpsPerTip_CheckedChanged);
			// 
			...
			// 
			// numeric_maxJumpsPerTrip
			// 
			this->numeric_maxJumpsPerTrip->Enabled = false;
			this->numeric_maxJumpsPerTrip->Location = System::Drawing::Point(74, 152);
			this->numeric_maxJumpsPerTrip->Minimum = System::Decimal(gcnew cli::array< System::Int32 >(4) {1, 0, 0, 0});
			this->numeric_maxJumpsPerTrip->Name = L"numeric_maxJumpsPerTrip";
			this->numeric_maxJumpsPerTrip->Size = System::Drawing::Size(124, 20);
			this->numeric_maxJumpsPerTrip->TabIndex = 5;
			this->numeric_maxJumpsPerTrip->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) {1, 0, 0, 0});
			this->numeric_maxJumpsPerTrip->ValueChanged += gcnew System::EventHandler(this, &EveGui::numeric_maxJumpsPerTrip_ValueChanged);
			// 
			// check_maxJumpsToStart
			// 
			this->check_maxJumpsToStart->AutoSize = true;
			this->check_maxJumpsToStart->Location = System::Drawing::Point(6, 115);
			this->check_maxJumpsToStart->Name = L"check_maxJumpsToStart";
			this->check_maxJumpsToStart->Size = System::Drawing::Size(59, 17);
			this->check_maxJumpsToStart->TabIndex = 9;
			this->check_maxJumpsToStart->Text = L"Enable";
			this->check_maxJumpsToStart->UseVisualStyleBackColor = true;
			this->check_maxJumpsToStart->CheckedChanged += gcnew System::EventHandler(this, &EveGui::check_maxJumpsToStart_CheckedChanged);
			// 
			// numeric_maxJumpsToStart
			// 
			this->numeric_maxJumpsToStart->Enabled = false;
			this->numeric_maxJumpsToStart->Location = System::Drawing::Point(74, 112);
			this->numeric_maxJumpsToStart->Minimum = System::Decimal(gcnew cli::array< System::Int32 >(4) {1, 0, 0, 0});
			this->numeric_maxJumpsToStart->Name = L"numeric_maxJumpsToStart";
			this->numeric_maxJumpsToStart->Size = System::Drawing::Size(124, 20);
			this->numeric_maxJumpsToStart->TabIndex = 4;
			this->numeric_maxJumpsToStart->Value = System::Decimal(gcnew cli::array< System::Int32 >(4) {1, 0, 0, 0});
			this->numeric_maxJumpsToStart->ValueChanged += gcnew System::EventHandler(this, &EveGui::numeric_maxJumpsToStart_ValueChanged);
			// 
			// text_shipVolume
			// 
			...
			// 
			// label_maxJumpsPerTrip
			// 
			this->label_maxJumpsPerTrip->AutoSize = true;
			this->label_maxJumpsPerTrip->Location = System::Drawing::Point(3, 135);
			this->label_maxJumpsPerTrip->Name = L"label_maxJumpsPerTrip";
			this->label_maxJumpsPerTrip->Size = System::Drawing::Size(100, 13);
			this->label_maxJumpsPerTrip->TabIndex = 7;
			this->label_maxJumpsPerTrip->Text = L"Max Jumps Per Trip";
			// 
			// text_availableFunds
			// 
			...
			// 
			// label_maxJumpsToStart
			// 
			this->label_maxJumpsToStart->AutoSize = true;
			this->label_maxJumpsToStart->Location = System::Drawing::Point(6, 94);
			this->label_maxJumpsToStart->Name = L"label_maxJumpsToStart";
			this->label_maxJumpsToStart->Size = System::Drawing::Size(101, 13);
			this->label_maxJumpsToStart->TabIndex = 3;
			this->label_maxJumpsToStart->Text = L"Max Jumps To Start";
			// 
			// tabPage_conversion
			// 
			...
			// group_analysis
			// 
			this->group_analysis->Controls->Add(this->group_estimate);
			this->group_analysis->Controls->Add(this->group_ROI);
			this->group_analysis->Controls->Add(this->group_security);
			this->group_analysis->Controls->Add(this->group_profitPerTrip);
			this->group_analysis->Controls->Add(this->group_analysedFiles);
			this->group_analysis->Controls->Add(this->group_volumePerTrip);
			this->group_analysis->Controls->Add(this->group_unitsPerTrip);
			this->group_analysis->Controls->Add(this->group_volumePerUnit);
			this->group_analysis->Controls->Add(this->group_jumpsPerTrip);
			this->group_analysis->Controls->Add(this->group_jumpsToStart);
			this->group_analysis->Controls->Add(this->group_fileAnalysed);
			this->group_analysis->Controls->Add(this->group_profitPerUnit);
			this->group_analysis->Controls->Add(this->group_infoPerUnit);
			this->group_analysis->Controls->Add(this->group_costPerUnit);
			this->group_analysis->Controls->Add(this->group_jumps);
			this->group_analysis->Controls->Add(this->group_trips);
			this->group_analysis->Controls->Add(this->group_profit);
			this->group_analysis->Controls->Add(this->group_profitIndex);
			this->group_analysis->Location = System::Drawing::Point(249, 149);
			this->group_analysis->Name = L"group_analysis";
			this->group_analysis->Size = System::Drawing::Size(480, 295);
			this->group_analysis->TabIndex = 2;
			this->group_analysis->TabStop = false;
			this->group_analysis->Text = L"Analysis";
			// 
			// group_ROI
			// 
			this->group_ROI->Controls->Add(this->info_ROI);
			this->group_ROI->Location = System::Drawing::Point(129, 251);
			...
			this->group_security->Location = System::Drawing::Point(248, 251);
			...
			this->group_profitPerTrip->Location = System::Drawing::Point(129, 61);
			this->group_profitPerTrip->Name = L"group_profitPerTrip";
			this->group_profitPerTrip->Size = System::Drawing::Size(113, 45);
			...
			// info_profitPerTrip
			// 
			this->info_profitPerTrip->Location = System::Drawing::Point(6, 20);
			...
			this->group_analysedFiles->Location = System::Drawing::Point(368, 16);
			this->group_analysedFiles->Name = L"group_analysedFiles";
			this->group_analysedFiles->Size = System::Drawing::Size(109, 234);
			...
			// 
			this->button_clearAnalysedFiles->Location = System::Drawing::Point(6, 209);
			...
			this->list_analysedFiles->Size = System::Drawing::Size(100, 186);
			...
			this->group_volumePerTrip->Location = System::Drawing::Point(129, 205);
			...
			this->group_unitsPerTrip->Location = System::Drawing::Point(248, 61);
			this->group_unitsPerTrip->Name = L"group_unitsPerTrip";
			this->group_unitsPerTrip->Size = System::Drawing::Size(113, 45);
			...
			// info_unitsPerTrip
			// 
			this->info_unitsPerTrip->Location = System::Drawing::Point(6, 20);
			...
			this->group_volumePerUnit->Location = System::Drawing::Point(10, 205);
			...
			this->group_jumpsPerTrip->Location = System::Drawing::Point(248, 154);
			...
			this->group_jumpsToStart->Location = System::Drawing::Point(129, 154);
			...
			this->group_fileAnalysed->Location = System::Drawing::Point(10, 16);
			...
			this->group_profitPerUnit->Location = System::Drawing::Point(248, 108);
			this->group_profitPerUnit->Name = L"group_profitPerUnit";
			this->group_profitPerUnit->Size = System::Drawing::Size(113, 45);
			...
			// info_profitPerUnit
			// 
			this->info_profitPerUnit->Location = System::Drawing::Point(6, 20);
			...
			this->group_infoPerUnit->Location = System::Drawing::Point(129, 108);
			this->group_infoPerUnit->Name = L"group_infoPerUnit";
			this->group_infoPerUnit->Size = System::Drawing::Size(113, 45);
			...
			// info_incomePerUnit
			// 
			this->info_incomePerUnit->Location = System::Drawing::Point(6, 20);
			...
			this->group_costPerUnit->Location = System::Drawing::Point(10, 108);
			this->group_costPerUnit->Name = L"group_costPerUnit";
			this->group_costPerUnit->Size = System::Drawing::Size(113, 45);
			...
			// info_costPerUnit
			// 
			this->info_costPerUnit->Location = System::Drawing::Point(6, 20);
			...
			this->group_jumps->Location = System::Drawing::Point(10, 154);
			...
			this->group_trips->Location = System::Drawing::Point(248, 205);
			...
			this->group_profit->Location = System::Drawing::Point(10, 251);
			...
			this->group_profitIndex->Location = System::Drawing::Point(10, 64);
			this->group_profitIndex->Name = L"group_profitIndex";
			this->group_profitIndex->Size = System::Drawing::Size(113, 42);
			...
			// group_estimate
			// 
			this->group_estimate->Controls->Add(this->info_estimate);
			this->group_estimate->Location = System::Drawing::Point(367, 251);
			this->group_estimate->Name = L"group_estimate";
			this->group_estimate->Size = System::Drawing::Size(110, 42);
			this->group_estimate->TabIndex = 16;
			this->group_estimate->TabStop = false;
			this->group_estimate->Text = L"Is an Estimate";
			// 
			// info_estimate
			// 
			this->info_estimate->Location = System::Drawing::Point(7, 16);
			this->info_estimate->Name = L"info_estimate";
			this->info_estimate->ReadOnly = true;
			this->info_estimate->Size = System::Drawing::Size(99, 20);
			this->info_estimate->TabIndex = 1;
			// 
			// EveGui
			// 
			this->ClientSize = System::Drawing::Size(741, 456);
			this->Controls->Add(this->group_loadedFiles);
			this->Controls->Add(this->group_analysis);
			...
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->numeric_maxJumpsPerTrip))->EndInit();
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^  >(this->numeric_maxJumpsToStart))->EndInit();
			this->tabPage_conversion->ResumeLayout(false);
			this->group_convertDB->ResumeLayout(false);
			this->group_convertDB->PerformLayout();
			this->group_analysis->ResumeLayout(false);
			...
			this->group_estimate->ResumeLayout(false);
			this->group_estimate->PerformLayout();
			this->ResumeLayout(false);

		}
#pragma endregion
private: System::Void check_debugOutput_CheckedChanged(System::Object^  sender, System::EventArgs^  e);
