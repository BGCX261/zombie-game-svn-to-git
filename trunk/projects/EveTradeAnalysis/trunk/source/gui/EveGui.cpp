...
namespace EveTradeAnalysis
{
	...
	System::Void EveGui::check_debugOutput_CheckedChanged(System::Object^ sender, System::EventArgs^ e) 
	{
		if(_marketAnalyser)
		{
			_marketAnalyser->setDebugOutput(check_debugOutput->Checked);
		}
	}
	...
	void EveGui::setProfitInfo(AutoMatic::Eve::ProfitIndex const & profit_)
	{
		...
		info_estimate->Text = (profit_._isEstimate ? "True" : "False");
